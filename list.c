 ...
 * list.c
 * List functions with ListNode and List structures
 * Constructs complete List structures with ListNodes
 * to have all of the coordinates.
 */
#include "list.h"
#include <stdio.h>
#include <stdlib.h>
...
void PrintList(List* list){
    ...
    Coordinate coord = list->head->data;
